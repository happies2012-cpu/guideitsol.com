          ...
          >
            ...
            <div className="space-y-3">
              ...
              <motion.div
                ...
                transition={{ type: "spring", stiffness: 300, damping: 20 }}
              >
                <div className="size-5 text-primary flex items-center justify-center flex-shrink-0">
                ...
                <a href="https://wa.me/918500647979" target="_blank" rel="noopener noreferrer" className="text-muted-foreground text-sm hover:text-green-500 transition-colors">
                  WhatsApp: +91 85006 47979
                </a>
              </motion.div>
            </div>
            <Link to="/contact">
