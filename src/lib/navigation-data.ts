    ...
    children: [
      {
        ...
        children: [
          ...
          { title: "Fitness App", href: generatePath("solutions", "fitness-app") },
          { title: "Utility App", href: generatePath("solutions", "utility-app") },
          { title: "Weather App", href: generatePath("solutions", "weather-app") },
        ],
      },
      {
        ...
        children: [
          ...
          { title: "Real Estate App", href: generatePath("solutions", "real-estate-app") },
          { title: "Travel App", href: generatePath("solutions", "travel-app") },
          { title: "Dating App", href: generatePath("solutions", "dating-app") },
        ],
      },
      {
        ...
        children: [
          ...
          { title: "Finance App", href: generatePath("solutions", "finance-app") },
          { title: "News App", href: generatePath("solutions", "news-app") },
          { title: "Gaming App", href: generatePath("solutions", "gaming-app") },
          { title: "Music App", href: generatePath("solutions", "music-app") },
          { title: "Shopping App", href: generatePath("solutions", "shopping-app") },
          { title: "Social Media App", href: generatePath("solutions", "social-media-app") },
        ],
      },
    ],
  },
